      ...
      <div className={barOpen ? 'bg-[#131313]' : ''}>
        <div className='flex flex-wrap items-center justify-between mx-auto p-4'>
            ...
            <div className='mobile-menu block md:hidden'>
              {
                !barOpen ? (
                  <button onClick={() => setBarOpen(true)} className='flex items-center px-3 py-2 border rounded border-amber-100 text-amber-50 hover:text-teal-200 hover:border-teal-200'>
                    <Bars3Icon className='h5- w-5' />
                  </button>
                 ) : (
                  <button onClick={() => setBarOpen(false)} className='flex items-center px-3 py-2 border rounded border-amber-100 text-amber-50 hover:text-teal-200 hover:border-teal-200'>
