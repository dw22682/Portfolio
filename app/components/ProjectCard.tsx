...
const ProjectCard = ({ imgURL, title, description, gitURL, previewURL }: typeDef) => {
  return (
    <div className='mt-4 mb-4 mr-2 ml-2 md:mt-10'>
        ...
        >
            <div className='overlay flex items-center justify-center absolute top-0 left-0 w-full h-full group-hover:flex group-hover:bg-[#141414]/80 group-focus:flex group-focus:bg-[#141414]'>
                <Link className='hidden group-hover:block group-focus:block mr-2 h-14 w-14 border-2 relative rounded-full group-hover:border-amber-100 hover:border-white group-focus:border-amber-100 focus:border-white group/link' href={gitURL}>
                ...
                <Link className='hidden group-hover:block group-focus:block ml-2 h-14 w-14 border-2 relative rounded-full group-hover:border-amber-100 hover:border-white group-focus:border-amber-100 focus:border-white group/link' href={previewURL}>
